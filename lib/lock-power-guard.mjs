...
/** LaunchAgent KeepAlive expects process exit on unlock. Session daemons must stay up. */
export function shouldExitProcessOnLockResume(env = process.env) {
  return String(env.WHATSEAL_SESSION ?? '0') !== '1';
}
